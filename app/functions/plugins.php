...
function enqueue_custom_assets_for_specific_page() {
    if (is_page('contact')) { // 固定ページのスラッグ指定
        // CSSファイルの読み込み
        wp_enqueue_style('custom-page-style', get_template_directory_uri() . '/public/plugins/p_cf7/style.css', array(), '1.0.0');
        
        // JavaScriptファイルの読み込み
        wp_enqueue_script('custom-page-script', get_template_directory_uri() . '/public/plugins/p_cf7/form.js', array('jquery'), '1.0.0', true);
